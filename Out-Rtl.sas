...
Proc sql;
	...
	Select			IndustryID, "T&i" as DataSeriesID, YearID, YearNo, CensusPeriodID, DataArrayID, Value
	from 			work.AnnVP;
quit;
%end;
...
proc sql;
	...
	Select 			IndustryID, DataSeriesID, "0000" as DataArrayID, YearID, CensusPeriodID, Value 	from work.MLSRatio union all
